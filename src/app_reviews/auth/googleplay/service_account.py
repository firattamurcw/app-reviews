...
class GoogleAuth:
    ...
    def __init__(self, service_account_path: str) -> None:
        ...
        self._private_key_pem: str = sa["private_key"]
        self._token_uri: str = sa.get("token_uri", _DEFAULT_TOKEN_URI)
    ...
    def authorization_header(self) -> str:
        """Exchange a self-signed JWT for an access token, return Bearer header."""
        jwt = self._build_jwt()
